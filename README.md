# Awesome Reproducible Research with stars
...
* Online course content
  ...
  * [AMIA2019](https://github.com/StatTag/amia-2019-spring-rr/) ⚠️ Archived - Pragmatic RR for Analysis, Dissemination and Publication
  * [PSU-PSY525](https://github.com/psu-psychology/psy-525-reproducible-research-2020) ⭐ 3 | 🐛 2 | 🌐 HTML | 📅 2024-02-07 - Transparent, Open, and Reproducible Research Practices in the Social and Behavioral Sciences
  * [Monash-RRR](https://monashdatafluency.github.io/r-rep-res/) - Reproducible Research in R workshop tutorial
  * [OSU-OSRR](https://github.com/cbahlai/OSRR_course) ⭐ 58 | 🐛 1 | 📅 2019-06-26 - An open science and reproducible research course targeted at organismal ecologists
...
* R
  * [repo](https://github.com/franapoli/repo) ⭐ 19 | 🐛 1 | 🌐 R | 📅 2026-08-04 - provenance framework package
  * [orderly](https://github.com/mrc-ide/orderly2) ⭐ 11 | 🐛 15 | 🌐 R | 📅 2026-01-21 - R package that automates writing reproducible analyses
...
* Linux-related (polyglot)
  * [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 256 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-18 - flight recorder for AI coding-agent runs: captures the model traffic, shell commands and per-turn file changes from outside the agent process, then re-executes the same run offline with the network off
...
* [SixSentences](https://github.com/SixSentences/sixsentences) ⭐ 5 | 🐛 69 | 🌐 Python | 📅 2026-09-16 - Self-hostable research workspace. Boolean literature searches compile to SQL against a versioned local Parquet snapshot of the corpus. Screening decisions, transformations, analyses, and manuscript claims stay linked to source and producing step. Apache-2.0, self-hosted via docker compose
* [Lune Research](https://github.com/RetrogradeLabs/lune-mcp-server) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - MCP server that grounds AI coding agents in full-text peer-reviewed papers, returning a verbatim supporting quote for every claim it verifies, so a generated citation can be checked against its source instead of trusted
...
* [CiteVahti](https://github.com/heidihelena/citevahti) ⭐ 1 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - local-first tool that checks whether each manuscript claim is supported by its cited source, with Zotero integration and blinded human-first rating records
...
* [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,851 | 🐛 36 | 📅 2026-09-12 - Everything related to the Docker containerization system
* [Awesome Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,624 | 🐛 33 | 📅 2026-09-19 - So many pipelines frameworks
* [Awesome R](https://github.com/qinwf/awesome-R#reproducible-research) ⭐ 6,512 | 🐛 29 | 🌐 R | 📅 2025-09-18 - Section on RR tools
* [Awesome Jupyter](https://github.com/adebar/awesome-jupyter) ⭐ 4,671 | 🐛 10 | 📅 2026-09-18 - Jupyter projects, libraries and resources
* [Awesome Semantic Web](https://github.com/semantalytics/awesome-semantic-web) ⭐ 1,691 | 🐛 31 | 📅 2026-09-08 - Semantic web and linked data resources.
