...
* Linux-related (polyglot)
  * [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 228 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - flight recorder for AI coding-agent runs: captures the model traffic, shell commands and per-turn file changes from outside the agent process, then re-executes the same run offline with the network off
...
* [Awesome Public Datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,916 | 🐛 159 | 📅 2026-09-11 - A topic-centric list of HQ open datasets
* [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,810 | 🐛 35 | 📅 2026-09-09 - Everything related to the Docker containerization system
...
* [Awesome Jupyter](https://github.com/adebar/awesome-jupyter) ⭐ 4,666 | 🐛 9 | 📅 2026-09-10 - Jupyter projects, libraries and resources
* [Awesome Semantic Web](https://github.com/semantalytics/awesome-semantic-web) ⭐ 1,686 | 🐛 29 | 📅 2026-09-08 - Semantic web and linked data resources.
